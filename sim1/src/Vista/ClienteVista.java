 ...
 */
public class ClienteVista extends javax.swing.JFrame implements VistaINt {
    ...
    ClienteVista(String text, String hostAddress, boolean simulado) throws IOException {
        initComponents();
        this.simulado = simulado;
        this.nombre = text;

        this.iptext.setText(hostAddress);
        this.Titulo.setText(simulado ? "Cliente Simulado" : "");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(Titulo, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)
                    ...
                    .addGroup(RegistroPanelLayout.createSequentialGroup()
                        .addGroup(RegistroPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(RegistroPanelLayout.createSequentialGroup()
                                ...
                                .addGap(37, 37, 37)
                                .addGroup(RegistroPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(provedorIp, javax.swing.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
                                    .addComponent(ProvedorPuerto)))
         ...
         if (!(ListasNumerosAleatoris.get(0).isEmpty() || ListasNumerosAleatoris.get(1).isEmpty() || ListasNumerosAleatoris.get(2).isEmpty())) {
            if (cli == null) {
                ...
                if (v.validate(provedorIp.getText()) && v.validate(iptext.getText())) {
                    alpanl.setEnabled(false);
                    try {
                        cli = new cliente(simulado,
                                RecursosIniciales,
                                0,
                                p,
                                this,
                        ...
                        cli.ListasNumerosAleatoris = ListasNumerosAleatoris;
                        RegistroJugador r = new RegistroJugador(cli.getJugadorNombre(), 2, cli.getIp(), cli.getPuerto(), "C");
                        ...
                        provedorIp.setEnabled(false);
                        ProvedorPuerto.setEnabled(false);
